  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800 antialiased overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-6 sm:pt-10 pb-16 sm:pb-24 max-w-6xl mx-auto w-full">
        ...
        {/* Main Title */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.18] max-w-4xl mb-5 sm:mb-6 px-2">
        ...
        {/* Subtitle */}
        <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-2xl leading-relaxed mb-8 sm:mb-10 px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto px-4">
          <Link
            href="/dashboard/builder"
            className="w-full sm:w-auto px-8 py-4 sm:py-5 rounded-full font-bold bg-rose-500 text-white shadow-xl shadow-rose-500/25 hover:bg-rose-600 hover:shadow-2xl hover:scale-[1.02] transition-all flex items-center justify-center gap-2 text-lg sm:text-xl"
          >
            <Heart className="w-5 h-5 sm:w-6 sm:h-6 fill-white" />
            <span>Create Her Proposal</span>
            <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6" />
          </Link>
          <Link
            href="/dashboard"
            className="w-full sm:w-auto px-6 py-4 sm:py-5 rounded-full font-bold bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-all text-base sm:text-lg text-center shadow-xs"
          >
        ...
        {/* ========================================================= */}
        <div className="mt-14 sm:mt-20 w-[320px] sm:w-[360px] mx-auto">
          <div className="relative">
            {/* Phone frame */}
            <div className="bg-slate-900 rounded-[3rem] p-3 shadow-2xl shadow-rose-900/20 ring-1 ring-slate-800">
              <div
                className="bg-gradient-to-b from-rose-100/90 via-white to-pink-50 rounded-[2.5rem] overflow-hidden flex flex-col justify-between relative"
                style={{ minHeight: "560px" }}
              >
                {/* Notch */}
                <div className="absolute top-0 w-full z-10 flex justify-center pt-3">
                ...
                <div className="pt-12">
                  {/* Music bar badge */}
                  <div className="mx-4 mb-4 bg-rose-50/90 border border-rose-200/60 rounded-xl px-3 py-1.5 flex items-center justify-between text-[11px] text-rose-700 font-medium">
                    <span className="flex items-center gap-1.5">
                      <Volume2 className="w-3.5 h-3.5 text-rose-500 animate-pulse" />
                      <span className="truncate">Tum Se Hi — Romantic Lofi</span>
                    </span>
                    <span className="text-[10px] text-rose-400">0:42 / 3:15</span>
                  </div>
                </div>
                ...
                <div className="px-6 py-4 text-center flex-1 flex flex-col justify-center">
                  ...
                  <h3 className="text-lg font-pacifico text-rose-500 mb-1">
                  ...
                  <div className="bg-white/95 rounded-2xl p-4 mb-5 border border-rose-100 shadow-xs text-left">
                  ...
                  <p className="text-sm font-extrabold text-slate-800 mb-4 leading-snug">
                    Will you be my girlfriend and make me the happiest person alive? 🥺💍
                  </p>

                  {/* Proposal Buttons */}
                  <div className="flex gap-2.5">
                    <div className="flex-1 py-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white text-xs font-bold rounded-xl shadow-md shadow-rose-300/50 flex items-center justify-center gap-1">
                      <span>YES, FOREVER! 😍</span>
                    </div>
                    <div className="flex-1 py-3 bg-slate-100 text-slate-400 text-[10px] font-bold rounded-xl flex items-center justify-center">
        ...
        <div className="w-full max-w-3xl mt-12 sm:mt-16 rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-rose-950 px-6 sm:px-10 py-8 sm:py-12 text-center text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/dashboard/builder"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-rose-500 hover:bg-rose-600 text-white font-bold px-8 py-4 sm:py-5 rounded-full transition-all shadow-lg shadow-rose-900/40 hover:scale-105 text-lg"
              >
                <Heart className="w-5 h-5 fill-white text-white" /> Start Her Proposal
              </Link>
            </div>
